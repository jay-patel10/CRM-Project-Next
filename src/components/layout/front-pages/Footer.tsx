      ...
      <div className='bg-[#211B2C]'>
        ...
        >
          <p className='text-white text-[13px]'>
            ...
            <span>{`❤️`}</span>
            <span>{` by `}</span>
            <Link href='https://Jay.com/' target='_blank' className='font-medium text-white'>
              Jay
            </Link>
          </p>
          <div className='flex gap-6 items-center'>
            <IconButton component={Link} size='small' href='https://github.com/Jay' target='_blank'>
              <i className='tabler-brand-github-filled text-white text-lg' />
            </IconButton>
            <IconButton component={Link} size='small' href='https://www.facebook.com/Jays/' target='_blank'>
              <i className='tabler-brand-facebook-filled text-white text-lg' />
            </IconButton>
            <IconButton component={Link} size='small' href='https://x.com/Jays' target='_blank'>
