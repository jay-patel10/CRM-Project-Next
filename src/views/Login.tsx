...
const Login = ({ mode }: { mode: SystemMode }) => {
  ...
  useEffect(() => {
    console.log('🧹 Login page mounted - clearing any old session data')
    localStorage.clear() // Clear everything on mount
  }, [])
  ...
  const onSubmit: SubmitHandler<FormData> = async (data: FormData) => {
    ...
    try {
      ...
      // ✅ Extract COMPLETE data from response
      ...
      console.log('💾 Saved to localStorage:', {
        ...
        refreshToken: refreshToken ? refreshToken.substring(0, 20) + '...' : 'N/A',
        userId: user.id,
        userName: user.name,
